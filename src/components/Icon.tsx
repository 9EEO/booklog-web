...
const paths: Record<IconName, ReactNode> = {
  ...
  chat: (
    <>
      <path d="M5.8 5A3.8 3.8 0 0 0 2 8.8v4.4A3.8 3.8 0 0 0 5.8 17H7v2.35a1 1 0 0 0 1.64.77L12.38 17h5.82a3.8 3.8 0 0 0 3.8-3.8V8.8A3.8 3.8 0 0 0 18.2 5H5.8Zm.4 4h7.6a1 1 0 1 1 0 2H6.2a1 1 0 1 1 0-2Zm0 3.2h5a1 1 0 1 1 0 2h-5a1 1 0 1 1 0-2Z" />
      {/* <path d="M17.5 2.2a.7.7 0 0 1 1.32 0l.34 1.02 1.02.34a.7.7 0 0 1 0 1.32l-1.02.34-.34 1.02a.7.7 0 0 1-1.32 0l-.34-1.02-1.02-.34a.7.7 0 0 1 0-1.32l1.02-.34.34-1.02Z" /> */}
    </>
  ),
  search: (
    <>
      {softCircle}
      <path d="M10.8 4a6.8 6.8 0 0 1 5.39 10.94l3.24 3.24a1 1 0 0 1-1.41 1.41l-3.24-3.24A6.8 6.8 0 1 1 10.8 4Zm0 2a4.8 4.8 0 1 0 0 9.6 4.8 4.8 0 0 0 0-9.6Z" />
    </>
  ),
  check: (
    <>
