...
const paths: Record<IconName, ReactNode> = {
  ...
  chat: (
    <>
      <path
        className="icon-bulk-soft"
        d="M4 6.5A3.5 3.5 0 0 1 7.5 3h9A3.5 3.5 0 0 1 20 6.5v5A3.5 3.5 0 0 1 16.5 15H12l-4.2 3.5A1.1 1.1 0 0 1 6 17.65V15.3A3.5 3.5 0 0 1 3 11.85V6.5Z"
      />
      <path d="M7.5 4A2.5 2.5 0 0 0 5 6.5v5A2.5 2.5 0 0 0 7.5 14H8a1 1 0 0 1 1 1v1.28l2.36-1.96A1 1 0 0 1 12 14h4.5a2.5 2.5 0 0 0 2.5-2.5v-5A2.5 2.5 0 0 0 16.5 4h-9Zm1 4h7a1 1 0 1 1 0 2h-7a1 1 0 1 1 0-2Zm0 3h4.5a1 1 0 1 1 0 2H8.5a1 1 0 1 1 0-2Z" />
    </>
  ),
  check: (
    <>
