...
const paths: Record<IconName, ReactNode> = {
  ...
  records: (
    <>
      <rect className="icon-bulk-soft" x="4" y="3" width="16" height="18" rx="3" />
  ...
  library: (
    <>
      <path className="icon-bulk-soft" d="M3 5a2 2 0 0 1 2-2h5a3 3 0 0 1 3 3v15H5a2 2 0 0 1-2-2V5Zm10 1a3 3 0 0 1 3-3h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-6V6Z" />
  ...
  swap: (
    <>
      <path className="icon-bulk-soft" d="M4 5h14a3 3 0 0 1 3 3v1H7a3 3 0 0 1-3-3V5Zm16 14H6a3 3 0 0 1-3-3v-1h14a3 3 0 0 1 3 3v1Z" />
  ...
  leaf: (
    <>
      <path className="icon-bulk-soft" d="M20.8 3.2C11.2 3 4.2 6.8 4 13.3c-.13 4.44 4.2 7.35 8.12 5.26C17 15.96 19.8 10.9 20.8 3.2Z" />
  ...
  quote: (
    <>
      <path className="icon-bulk-soft" d="M3 5h8v8H7v6H3V5Zm10 0h8v8h-4v6h-4V5Z" />
  ...
  book: (
    <>
      <path className="icon-bulk-soft" d="M3 4h8a3 3 0 0 1 3 3v14H6a3 3 0 0 1-3-3V4Zm11 3a3 3 0 0 1 3-3h4v14a3 3 0 0 1-3 3h-4V7Z" />
  ...
  calendar: (
    <>
      <rect className="icon-bulk-soft" x="3" y="5" width="18" height="16" rx="3" />
  ...
  edit: (
    <>
      <path className="icon-bulk-soft" d="M4 14.5V20h5.5L20 9.5 14.5 4 4 14.5Z" />
  ...
  copy: (
    <>
      <rect className="icon-bulk-soft" x="7" y="3" width="14" height="14" rx="3" />
  ...
  camera: (
    <>
      <rect className="icon-bulk-soft" x="2" y="5" width="20" height="16" rx="4" />
  ...
  tier: (
    <>
      <rect className="icon-bulk-soft" x="3" y="3" width="18" height="5" rx="2" />
      <rect className="icon-bulk-soft" x="3" y="10" width="14" height="5" rx="2" />
      <rect className="icon-bulk-soft" x="3" y="17" width="10" height="5" rx="2" />
