...
export const MiniBook = ({ book, compact = false, supportingText, coverStyle, coverTransitionKey }: MiniBookProps) => {
  ...
  return (
    <div className={`flex items-center gap-3 ${compact ? '' : 'min-w-0'}`}>
      ...
      <div className="min-w-0 text-left">
        ...
        {supportingText && (
          <p className="mt-1 truncate text-[11px] font-semibold text-stone-400">
            {supportingText}
          </p>
        )}
        {!compact && (
